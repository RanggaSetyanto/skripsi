    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <ol class="breadcrumb mb-4">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url('pendaftaranstaf') ?>">Pendaftaran</a></li>
            ...
            <div class="card shadow rounded-4">
                ...
                <div class="card-body p-4">
                    <form action="<?= base_url('pendaftaranstaf/update/' . $pendaftaran['id']) ?>" method="post">
                        <?= csrf_field() ?>
                        ...
                        <div class="text-end">
                            ...
                            <a href="<?= base_url('pendaftaranstaf') ?>" class="btn btn-secondary rounded-pill px-4">Batal</a>
                        </div>
                    </form>
                </div>
            </div>
