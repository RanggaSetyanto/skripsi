...
<script>
    function bukaModalTambah() {
        ...
        document.getElementById('pembayaranForm').action = "<?= base_url('pembayaranstaf/simpan') ?>";
    ...
    function bukaModalEdit(id, pendaftaran_id, tanggal_pembayaran, jumlah_pembayaran, metode_pembayaran, bukti_pembayaran) {
        ...
        document.getElementById('pembayaranForm').action = "<?= base_url('pembayaranstaf/update') ?>/" + id;
    ...
    function konfirmasiHapus(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = "<?= base_url('pembayaranstaf/hapus') ?>/" + id;
            }
        });
    }
</script>
