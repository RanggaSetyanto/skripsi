...
<div id="layoutSidenav_content">
    ...
    <div class="container-fluid px-4">
            ...
            <div class="card mb-4 shadow rounded-4">
                ...
                <div class="card-body">
                    <a href="<?= base_url('jamaahstaf/tambah') ?>" class="btn btn-primary mb-3 rounded-pill px-4">Tambah Jamaah</a>
                                ...
                                <?php if (!empty($jamaah)) : ?>
                                    <?php $no = 1; foreach ($jamaah as $data): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url('jamaahstaf/edit/' . $data['id']) ?>" class="btn btn-sm btn-warning rounded-pill">Edit</a>
                                                <a href="<?= base_url('jamaahstaf/hapus/' . $data['id']) ?>" class="btn btn-sm btn-danger rounded-pill" onclick="return confirm('Yakin ingin menghapus data ini?')">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php else: ?>
