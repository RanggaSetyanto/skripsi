...
class PendaftaranController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('User/pendaftaranstaf/index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('User/pendaftaranstaf/tambah', $data);
    }
    ...
    public function simpan()
    {
        ...
        return redirect()->to('pendaftaranstaf')->with('success', 'Data berhasil ditambahkan.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('User/pendaftaranstaf/edit', $data);
    }
    ...
    public function update($id)
    {
        ...
        return redirect()->to('pendaftaranstaf')->with('success', 'Data berhasil diupdate.');
    }

    public function delete($id)
    {
        $this->pendaftaranModel->delete($id);
        return redirect()->to('pendaftaranstaf')->with('success', 'Data berhasil dihapus.');
    }
    ...
    public function cetak($id)
    {
        ...
        if (!$data) {
            return redirect()->to('pendaftaranstaf')->with('error', 'Data tidak ditemukan');
        }

        // Load HTML ke PDF
        $html = view('user/pendaftaranstaf/cetak', ['pendaftaran' => $data]);
